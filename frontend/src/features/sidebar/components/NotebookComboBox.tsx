...
import { Notebook } from "&/github.com/nodetec/comet/db/models";
import { NotebookService } from "&/github.com/nodetec/comet/service";
            ...
            <CommandList>
              ...
              <CommandGroup>
                ...
                {data?.map((notebook) => (
                  ...
                  >
                    <span className="line-clamp-1 truncate text-ellipsis whitespace-break-spaces break-all">
                      {notebook.Name}
                    </span>
