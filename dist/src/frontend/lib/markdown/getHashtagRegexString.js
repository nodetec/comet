...
exports.getHashtagRegexStringChars = getHashtagRegexStringChars;
exports.getHashtagRegexString = getHashtagRegexString;
// TODO: put this somewhere more general for frontend and backend
function getHashtagRegexStringChars() {
    // Latin accented characters
    // Excludes 0xd7 from the range
    // (the multiplication sign, confusable with "x").
    // Also excludes 0xf7, the division sign
    const latinAccents = "\xc0-\xd6" +
        "\xd8-\xf6" +
        "\xf8-\xff" +
        "\u0100-\u024f" +
        "\u0253-\u0254" +
    ...
    // equivalent of \p{L}
    const unicodeLetters = "\u0041-\u005A\u0061-\u007A\u00AA\u00B5\u00BA\u00C0-\u00D6\u00D8-\u00F6" +
        "\u00F8-\u0241\u0250-\u02C1\u02C6-\u02D1\u02E0-\u02E4\u02EE\u037A\u0386" +
        "\u0388-\u038A\u038C\u038E-\u03A1\u03A3-\u03CE\u03D0-\u03F5\u03F7-\u0481" +
        "\u048A-\u04CE\u04D0-\u04F9\u0500-\u050F\u0531-\u0556\u0559\u0561-\u0587" +
        "\u05D0-\u05EA\u05F0-\u05F2\u0621-\u063A\u0640-\u064A\u066E-\u066F" +
    ...
    const unicodeAccents = "\u0300-\u036F\u0483-\u0486\u0591-\u05B9\u05BB-\u05BD\u05BF" +
        ...
        "\uFE20-\uFE23";
    // equivalent of \p{Dn}
    const unicodeDigits = "\u0030-\u0039\u0660-\u0669\u06F0-\u06F9\u0966-\u096F\u09E6-\u09EF" +
        "\u0A66-\u0A6F\u0AE6-\u0AEF\u0B66-\u0B6F\u0BE6-\u0BEF\u0C66-\u0C6F" +
        "\u0CE6-\u0CEF\u0D66-\u0D6F\u0E50-\u0E59\u0ED0-\u0ED9\u0F20-\u0F29" +
        "\u1040-\u1049\u17E0-\u17E9\u1810-\u1819\u1946-\u194F\u19D0-\u19D9" +
        "\uFF10-\uFF19";
    // A hyphen can be included in hashtags, but a hashtag cannot have only hyphens.
    const hyphen = "\\-"; // Escape hyphen
    // An alpha char is a unicode chars including unicode marks or
    // letter or char in otherChars range
    const alpha = unicodeLetters + unicodeAccents + otherChars + hyphen;
...
function getHashtagRegexString() {
    ...
    const hashtagAlphanumeric = "[" + alphanumeric + "\\-]"; // Escape hyphen in alphanumeric
    const hashtagBoundary = "^|$|[^&/" + alphanumeric + "\\-]"; // Escape hyphen in boundary
...
//# sourceMappingURL=getHashtagRegexString.js.map