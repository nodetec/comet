...
function DialogPopup({
  ...
  return (
    <Dialog.Popup
      className={cn(
        "bg-card text-card-foreground fixed top-1/2 left-1/2 z-50 -translate-x-1/2 -translate-y-1/2 rounded-xl border shadow-lg transition-all duration-200 outline-none data-[closed]:scale-95 data-[closed]:opacity-0 data-[open]:scale-100 data-[open]:opacity-100",
        className,
      )}
      {...props}
    />
